...
import { LAYOUT_SAVE_DEBOUNCE_MS, ZOOM_MAX, ZOOM_MIN } from '../constants';
import type { ExpandDirection } from '../editor/editorActions';
import {
  canPlaceFurniture,
  expandLayout,
  getWallPlacementRow,
...
// Local postMessage stub (no VS Code API in standalone mode)
const postMessage = (msg: unknown) => { console.log('[PixelAgent]', msg); };
...
export function useEditorActions(
  ...
  // Called on layoutLoaded to set the initial checkpoint
