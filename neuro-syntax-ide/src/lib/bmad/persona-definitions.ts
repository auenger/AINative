...
export const PERSONA_CATEGORIES: Record<PersonaCategory, { label: string; icon: string }> = {
  product: { label: '产品', icon: '🎯' },
  technical: { label: '技术', icon: '⚙️' },
  design: { label: '设计', icon: '🎨' },
  quality: { label: '质量', icon: '🛡️' },
  operations: { label: '运营', icon: '📈' },
