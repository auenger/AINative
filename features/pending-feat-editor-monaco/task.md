...
- [ ] EditorView 中央区域替换 pre/code 为 Monaco Editor 组件
- [ ] 配置深色主题 (与原型设计系统一致)
- [ ] 语言映射: 按文件扩展名设置 Monaco language
- [ ] 编辑器配置: 字体 JetBrains Mono, 行号, 代码折叠

### 2. 多 Tab 管理
- [ ] 实现 Tab 状态管理 (openFiles Map)
- [ ] 双击文件树 → 打开新 Tab / 切换到已有 Tab
- [ ] Tab 标签显示文件名 + 修改标记 (圆点)
- [ ] Tab 关闭逻辑 (未保存提示)
- [ ] Tab 切换保持光标和滚动状态
