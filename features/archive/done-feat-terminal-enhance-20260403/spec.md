...
- **Merged Branch**: feature/feat-terminal-enhance
- **Merge Commit**: bc092e0
- **Archive Tag**: feat-terminal-enhance-20260403
- **Conflicts**: None
- **Verification**: Passed (4/4 Gherkin scenarios, build pass)
- **Development Stats**: 1 commit, 5 files changed (+309/-34)
