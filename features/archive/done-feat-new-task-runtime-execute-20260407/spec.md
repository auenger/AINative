...
### General Checklist
- [x] dispatch_to_runtime 相关代码完全移除
- [x] utils.ts 中的 dispatch 工具函数清理
- [x] 与 REQ Agent 执行模型一致（session + execute + chunk）
- [x] fs://workspace-changed 事件监听正确
- [x] PM Agent 路径不受影响

## Merge Record

- **Completed**: 2026-04-07T10:35:00Z
- **Merged Branch**: feature/feat-new-task-runtime-execute
- **Merge Commit**: 15c560c
- **Archive Tag**: feat-new-task-runtime-execute-20260407
- **Conflicts**: None
- **Verification**: PASS — 4/4 Gherkin scenarios validated, Vite build passes
- **Stats**: 3 commits, 8 files changed, started 2026-04-07T10:15:00Z
